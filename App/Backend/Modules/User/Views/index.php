...
<table>
	...
	<?php foreach ( $user_a as $user_ ): ?>
		<tr>
			...
			<td>
				<a href="<?= \OCFram\RouterFactory::getRouter('Backend')->getUrl( 'User', 'update',['id'=> $user_[ 'id' ]]) ?>"><img src="/img/update.png" alt="Modifier" /></a>
				<a href="<?= \OCFram\RouterFactory::getRouter('Backend')->getUrl( 'User', 'delete',['id'=> $user_[ 'id' ]]) ?>"><img src="/img/delete.png" alt="Supprimer" /></a>
			</td>
		</tr>
	<?php endforeach; ?>
</table>